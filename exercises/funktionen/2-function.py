...
def count_down():
    ...
    '''
    eingabe = input(
        "Gib eine Zahl ein: ")  # Variable eingabe erhält den Text zugewiesen, welchen die Benutzer:in auf der Konsole eingibt
    # Funktion int(...) wandelt den Wert von Eingabe in eine ganze Zahl um
    zahl = int(eingabe)
